      ...
      <div className="mb-3">
        ...
        <Row className="align-items-center">
          ...
          <Col className="pt-3 order-3 order-md-2">
            <ProgressBar variant="warning" now={50} className="mb-3" style={{ height: "6px" }} />
            <ProgressBar variant="warning" now={36} className="mb-3" style={{ height: "6px" }} />
            <ProgressBar variant="warning" now={9} className="mb-3" style={{ height: "6px" }} />
            <ProgressBar variant="warning" now={3} className="mb-3" style={{ height: "6px" }} />
            <ProgressBar variant="warning" now={2} className="mb-3" style={{ height: "6px" }} />
          </Col>
